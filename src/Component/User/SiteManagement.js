...
import { Subscribe } from '../../Config/Commonapi';
...
function SiteManagement() {
    ...
    return (
        <div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse mx-auto ml-5  mx-3 my-3">
                            <ul class="navbar-nav mr-auto ml-5">
                                ...
                                <li class="nav-item active ml-5">
                                    <a class="nav-link font-weight-bolder text-uppercase mr-sm-4" href="/bloglist">Blog</a>
                                </li>
                                <li class="nav-item ml-5">
                                    <a class="nav-link active font-weight-bolder text-uppercase mr-sm-4" href="/contact">Contact</a>
                                </li>
                                <li class="nav-item ml-5">
                                    <a class="nav-link active font-weight-bolder text-uppercase mr-sm-4" href="/about">About Us</a>
                                </li>
            ...
            <div class="navbar  navbar-expand-lg navbar navbar-light bg-light pt-5 pb-4 border-bottom   ">
            ...
            {/* <hr/> */}
            <div class="navbar  navbar-expand-lg navbar navbar-light bg-light pt-5 pb-5  ">
