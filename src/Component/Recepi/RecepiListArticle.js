...
import { Subscribe, SearchRecepi, GetAllBlog, GetAllRecipe, PopularBlog, SiteOptions } from '../../Config/Commonapi';
      ...
      <nav class="navbar navbar-expand-lg navbar navbar-light bg-light border-bottom  fixed-top ">
        ...
        <div class="container">
          <div class="row">
                  ...
                  return (
                    <div>
                      ...
                      <div class="row">
                        <div class="col pb-5">
                          <div class="">
                            <img src={`http://95.111.202.157:8001/${item.recipeId.image}`} clas="float-left img-fluid" alt="fftgh" style={{ width: "400px", height: "250px" }} />
                          </div>
            ...
            <div class="col-xs-5 col-sm-6 col-lg-4 float-left">
              <div class="row ">
                      ...
                      <div>
                        ...
                        <div class="col-sm-2">
                          <div class="float-left mr-5">
                            <img src={`http://95.111.202.157:8001/${item.image}`} clas="float-left img-fluid" alt="fftgh" style={{ width: "200px", height: "150px" }} />
                          </div>
                ...
                <div class="col-xs-5 col-sm-6 col-lg-4 pt-5 float-left">
                  <img src="https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8NHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60"
                    alt="des" style={{ height: '300px', width: "300px" }} class="rounded-lg" />
                </div>
              </div>
            </div>
          </div>
...
export default RecepiListArticle;
