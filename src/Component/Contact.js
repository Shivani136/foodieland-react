...
import { AddContact, Subscribe, GetAllRecipe } from '../Config/Commonapi';
        ...
        <div>
            ...
            <div id="page-content-wrapper">
                ...
                <div className='banner'>
                    <h1 className='banner pb-5 pt-5'>Contact US</h1>
                </div>
                        ...
                        <div class="col-sm-7 pt-1  ">
                            <form onSubmit={contact}>
                                    ...
                                    <div class="col ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control rounded-lg p-4" placeholder="Enter your subject"
                                                value={subject} onChange={(e) => { setSubject(e.target.value) }} required autofocus />
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group" value={enquiryType} onChange={(e) => { setEnquiryType(e.target.value) }} required autofocus>
                                ...
                                <div class="row pt-2">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control rounded-lg" rows="4"
                                                value={message} onChange={(e) => { setMessage(e.target.value) }} required autofocus >
                                ...
                                <div className='pt-5 pb-5'>
                                    <button type="button" class="btn btn-dark float-left pl-5 pr-5 pt-3 pb-3 rounded-lg" onClick={contact}>SUBMIT</button>
                                </div>
                            </form>
                        </div>
                                        ...
                                        <div class="col-3">
                                            ...
                                            <div class="row">
                                                <div class="col float-right">
                                                    <p class="text-dark">{item.recipeId.cookTime}
                                                        <br />
                                                        {item._id}</p>
